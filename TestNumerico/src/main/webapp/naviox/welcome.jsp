...
En TestNumerico-labels_es.properties:
TestNumerico=Tu aplicación
TestNumerico[description]=Tu aplicación hace esto y lo otro

En TestNumerico-messages_en.properties:
